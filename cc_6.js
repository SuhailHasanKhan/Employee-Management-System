...
class Manager extends Employee {
    ...
    describe() {
        return `${super.describe()}\t|\t Position: MANAGER\t|\tTeam Size: ${this.teamSize}`
    }
}
...
let mng2 = new Manager('Gary Gills', 'Accounting', 120);
let mng3 = new Manager('Rocky Ray', 'Private Equity', 81);
...
let co = new Company('SHK Partners');
co.addEmployee(emp1);
co.addEmployee(emp2);
co.addEmployee(emp3);
co.addEmployee(mng1);
